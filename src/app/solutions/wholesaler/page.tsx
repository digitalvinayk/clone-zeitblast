        ...
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Real Estate Wholesaler Solutions
            </h1>
            <p className="text-xl text-gray-600">
              Streamline your wholesaling business with intelligent SMS automation
            </p>
          </div>
          ...
          <Card variant="elevated" padding="lg" className="mb-8">
            <div className="prose max-w-none">
              ...
              <p className="text-gray-600 mb-6">
                We're building powerful tools specifically designed for real estate wholesalers.
                Sign up now to get early access and special pricing when we launch.
              </p>
              ...
              <div className="bg-gradient-to-r from-brand-teal/10 to-brand-blue/10 border-2 border-brand-teal/30 rounded-lg p-6 mb-6">
                ...
                <ul className="space-y-2 text-gray-700">
                  ...
                  <li>✓ Investor matching and notifications</li>
                  <li>✓ Deal pipeline tracking</li>
                  <li>✓ CRM integration for wholesaling</li>
                </ul>
              </div>
