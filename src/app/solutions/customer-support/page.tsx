        ...
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Deliver exceptional customer service with two-way SMS conversations
            </p>
          </div>
          ...
          <Card variant="elevated" padding="lg" className="mb-8">
            <div className="prose max-w-none">
              ...
              <p className="text-gray-600 mb-6">
                Customer support features are in development. Meet your customers where
                they are with fast, personal SMS support.
              </p>
              ...
              <div className="bg-gradient-to-r from-brand-teal/10 to-brand-blue/10 border-2 border-brand-teal/30 rounded-lg p-6 mb-6">
                ...
                <ul className="space-y-2 text-gray-700">
                  <li>✓ Unified inbox for all conversations</li>
                  <li>✓ Automated responses and routing</li>
